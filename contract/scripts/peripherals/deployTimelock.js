...
async function getArbValues() {
  ...
  return { vault, tokenManager, blpManager, positionRouter, positionManager, blu }
}
...
async function getAvaxValues() {
  ...
  const blpManager = { address: "0x3a417b2949d59B129e5C6c0A52114335C780B9AE" }
  ...
  const blu = { address: "0x62edc0692BD897D2295872a9FFCac5425011c661" }
...
async function getGoerliValues() {
  ...
  const blpManager = { address: "0x803f874315Dd373D4F56cfD322386334a09aa39b" }
  ...
  const blu = { address: "0x2F85207AAfF05040e7fcE48c5ed80d01c4C38597" }
...
async function getCronosValues() {
  ...
  const blpManager = { address: "0x32889DD3209b32fEc343A4c8081f54aBEFFC06b8" }
  ...
  const blu = { address: "0x1542bA4CA0fb6D1B4476a933B292002fd1959A52" }
...
async function main() {
  ...
  const { vault, tokenManager, blpManager, positionRouter, positionManager, blu } = await getValues()
  ...
  // await sendTxn(deployedTimelock.signalApprove(blu.address, admin, "1000000000000000000"), "deployedTimelock.signalApprove")
}
