...
async function main() {
  ...
  await sendTxn(plp.setMinter(plpManager.address, false), "plp.setMinter")
  await sendTxn(usdg.removeVault(plpManager.address), "usdg.removeVault")
  await sendTxn(vault.setManager(plpManager.address, false), "vault.setManager")
}
