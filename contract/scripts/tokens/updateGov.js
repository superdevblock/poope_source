...
async function getArbValues() {
  ...
  const addresses = [
    ...
    ["blu", "0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a"],
    ["esBlu", "0xf42Ae1D54fd613C9bb14810b0588FaAa09a426cA"],
    ["bnBlu", "0x35247165119B69A40edD5304969560D0ef486921"],
    ["usdg", "0x45096e7aA921f27590f8F19e457794EB09678141"],
    ["bluVester", "0x199070DDfd1CFb69173aa2F7e20906F26B363004"],
    ["blpVester", "0xA75287d2f8b217273E7FCD7E86eF07D33972042E"],
  ]

  const trackers = [
    ["stakedBluTracker", "0x908C4D94D34924765f1eDc22A1DD098397c59dD4"],
    ["bonusBluTracker", "0x4d268a7d4C16ceB5a606c173Bd974984343fea13"],
    ["feeBluTracker", "0xd2D1162512F927a7e282Ef43a362659E4F2a728F"],
...
async function getAvaxValues() {
  ...
  const addresses = [
    ...
    ["blu", "0x62edc0692BD897D2295872a9FFCac5425011c661"],
    ["esBlu", "0xFf1489227BbAAC61a9209A08929E4c2a526DdD17"],
    ["bnBlu", "0x8087a341D32D445d9aC8aCc9c14F5781E04A26d2"],
    ["usdg", "0xc0253c3cC6aa5Ab407b5795a04c28fB063273894"],
    ["bluVester", "0x472361d3cA5F49c8E633FB50385BfaD1e018b445"],
    ["blpVester", "0x62331A7Bd1dfB3A7642B7db50B5509E57CA3154A"],
  ]

  const trackers = [
    ["stakedBluTracker", "0x2bD10f8E93B3669b6d42E74eEedC65dd1B0a1342"],
    ["bonusBluTracker", "0x908C4D94D34924765f1eDc22A1DD098397c59dD4"],
    ["feeBluTracker", "0x4d268a7d4C16ceB5a606c173Bd974984343fea13"],
