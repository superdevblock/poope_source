          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the POOPE Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                POOPE Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the POOPE Protocol offers in any manner you choose unless it misleads someone about
                the POOPE Protocol.
              </p>
              <p className="body-text">
                2.2 Bluespade.exchange is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
            ...
            <div className="section">
              ...
              <p className="body-text">
              Bluespade.exchange is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the POOPE tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall Bluespade.exchange be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall Bluespade.exchange's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by Bluespade.exchange, or your use of the service(s) provided by Bluespade.exchange, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from Bluespade.exchange, which the token holders of POOPE determine. Due to
              ...
              <p className="body-text">
              Bluespade.exchange will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
              Bluespade.exchange may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://app.bluespade.exchange/#/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and Bluespade.exchange concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. Bluespade.exchange will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. Bluespade.exchange may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 Bluespade.exchange will have no responsibility or liability for any failure or delay in performance of the Site,
