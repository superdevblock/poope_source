...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  const cronosPositionStatsUrl = getServerUrl(CRONOS, "/position_stats");
      ...
      <div className="Home-cta-section">
        <div className="Home-cta-container default-container">
          ...
          <div className="Home-cta-options">
            <div className="Home-cta-option Home-cta-option-cronos">
              <div className="Home-cta-option-icon">
                <img src={cronosIcon} alt="Cronos Icon" />
              </div>
              <div className="Home-cta-option-info">
                <div className="Home-cta-option-title">Cronos</div>
            ...
            <div className="Home-cta-option Home-cta-option-ava">
              <div className="Home-cta-option-icon">
                <img src={goerliIcon} alt="Goerli Icon" />
              </div>
              <div className="Home-cta-option-info">
                <div className="Home-cta-option-title">Goerli</div>
                <div className="Home-cta-option-action">
                  <LaunchExchangeButton />
                </div>
              </div>
      ...
      {/* <div className="Home-faqs-section">
        <div className="Home-faqs-container default-container">
          <div className="Home-faqs-introduction">
            ...
            <a href="https://bluespadexyz.gitbook.io/bluespade/" className="default-btn Home-faqs-documentation">Documentation</a>
          </div>
