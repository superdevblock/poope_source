...
const GOERLI_GMX = getContract(GOERLI_TESTNET, "GMX");
...
export const EXTERNAL_LINKS = {
  ...
  [GOERLI_TESTNET]: {
    bungee: `https://multitx.bungee.exchange/?toChainId=5&toTokenAddress=${GOERLI_GMX}`,
    banxa: "https://gmx.banxa.com/?coinType=ETH&fiatType=USD&fiatAmount=500&blockchain=goerli",
    networkWebsite: "https://ethereum.org/",
    buyGmx: {
      banxa: "https://gmx.banxa.com/?coinType=GMX&fiatType=USD&fiatAmount=500&blockchain=goerli",
      uniswap: `https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=${GOERLI_GMX}`,
    },
  },
  [CRONOS]: {
    ...
    buyGmx: {
      ...
      uniswap: `https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=${CRONOS_GMX}`,
    },
  },
};
