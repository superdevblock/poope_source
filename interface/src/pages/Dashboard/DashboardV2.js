...
import goerli16Icon from "img/ic_goerli_16.svg";
import goerli24Icon from "img/ic_goerli_24.svg";
...
import { ARBITRUM, AVALANCHE, GOERLI_TESTNET, CRONOS, getChainName } from "config/chains";
...
const ACTIVE_CHAIN_IDS = [/* ARBITRUM, AVALANCHE, GOERLI_TESTNET, */CRONOS];
...
export default function DashboardV2() {
  ...
  // const { infoTokens: infoTokensGoerli } = useInfoTokens(null, GOERLI_TESTNET, active, undefined, undefined);
  const { infoTokens: infoTokensCronos } = useInfoTokens(null, CRONOS, active, undefined, undefined);

  const { data: currentFees } = useSWR(
    infoTokensCronos[AddressZero].contractMinPrice// infoTokensArbitrum[AddressZero].contractMinPrice && infoTokensGoerli[AddressZero].contractMinPrice
  ...
  const eth = infoTokens[getTokenBySymbol(chainId, chainId === CRONOS ? "WCRO" : "ETH").address];
  ...
  const { gmxPrice, gmxPriceFromCronos, gmxPriceFromGoerli } = useGmxPrice(
    chainId,
  ...
  let { eth: goerliStakedGmx, cronos: cronosStakedGmx, total: totalStakedGmx } = useTotalGmxStaked();
        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Stats</Trans>
              {chainId === AVALANCHE && <img src={avalanche24Icon} alt="avalanche24Icon" />}
              {chainId === ARBITRUM && <img src={arbitrum24Icon} alt="arbitrum24Icon" />}
              {chainId === GOERLI_TESTNET && <img src={goerli24Icon} alt="goerli24Icon" />}
            ...
            {/* <div className="Page-description">
              ...
              { chainId === ARBITRUM && <ExternalLink href="https://stats.bluespade.exchange">https://stats.bluespade.exchange</ExternalLink> }
              { chainId === AVALANCHE && <ExternalLink href="https://stats.bluespade.exchange/avalanche">https://stats.bluespade.exchange/avalanche</ExternalLink> }
              { chainId === GOERLI_TESTNET && <ExternalLink href="https://stats.bluespade.exchange/goerli">https://stats.bluespade.exchange/goerli</ExternalLink> }
              { chainId === CRONOS && <ExternalLink href="https://stats.bluespade.exchange/cronos">https://stats.bluespade.exchange/cronos</ExternalLink> }
            </div> */}
          </div>
        </div>
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          // goerliValue={totalVolumeDelta? formatNumber(totalVolumeDelta, { currency: true, compact: false }) : `$0`}
                          cronosValue={totalVolumeDelta? formatNumber(totalVolumeDelta, { currency: true, compact: false }) : `$0`}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          cronosValue={positionStatsInfo?.totalLongPositionSizes}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          cronosValue={positionStatsInfo?.totalShortPositionSizes}
                      ...
                      <TooltipComponent
                        ...
                        renderContent={() => (
                          <StatsTooltip
                            ...
                            cronosValue={currentFees?.[CRONOS]}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          // goerliValue={totalFees? formatNumber(totalFees, { currency: true, compact: false }) : `$0`}
                          cronosValue={totalFees? formatNumber(totalFees, { currency: true, compact: false }) : `$0`}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          // goerliValue={totalVolume? formatNumber(totalVolume, { currency: true, compact: false }) : `$0`}
                          cronosValue={totalVolume? formatNumber(totalVolume, { currency: true, compact: false }) : `$0`}
                            ...
                            renderContent={() => (
                              <>
                                <StatsTooltipRow
                                  ...
                                  value={formatAmount(gmxPriceFromCronos, USD_DECIMALS, 2, true)}
                                  showDollar={true}
                                />
                                {/* <StatsTooltipRow
                                  label={t`Price on Goerli`}
                                  value={formatAmount(gmxPriceFromGoerli, USD_DECIMALS, 2, true)}
                                  showDollar={true}
                                /> */}
                              </>
                            )}
                    ...
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        ...
                        {chainId === CRONOS ? (
                          ...
                          <img src={goerli16Icon} alt={t`Goerli Icon`} className="selected-network-symbol" />
                        )}
                      </div>
                      <div className="App-card-title-mark-info">
                  ...
                  {visibleTokens.map((token) => {
                    ...
                    return (
                      <tr key={token.symbol}>
                        ...
                        <td>${formatKeyAmount(tokenInfo, "minPrice", USD_DECIMALS, token.symbol.includes("CRO") ? 4 : 2, true)}</td>
                        <td>
                          <TooltipComponent
                  ...
                  <div className="App-card" key={token.symbol}>
                    ...
                    <div className="App-card-content">
                      <div className="App-card-row">
                        ...
                        <div>${formatKeyAmount(tokenInfo, "minPrice", USD_DECIMALS, token.symbol.includes("CRO") ? 4 : 2, true)}</div>
                      </div>
                      <div className="App-card-row">
                        <div className="label">
                          <Trans>Pool</Trans>
