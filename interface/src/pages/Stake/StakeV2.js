...
import { ARBITRUM, CRONOS, getChainName, getConstant } from "config/chains";
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const { gmxPrice, gmxPriceFromArbitrum, gmxPriceFromAvalanche, gmxPriceFromGoerli, gmxPriceFromCronos } = useGmxPrice(
    chainId,
  ...
  let { avax: avaxGmxStaked, arbitrum: arbitrumGmxStaked, cronos: cronosGmxStaked, total: totalGmxStaked } = useTotalGmxStaked();
