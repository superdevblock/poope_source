...
import { ARBITRUM, CRONOS, getChainName, getConstant, IS_NETWORK_DISABLED } from "config/chains";
...
function shouldSwap(collateralToken, receiveToken) {
  ...
  // @see https://github.com/BlueSpade-Dex/gmx-interface/blob/master/src/pages/Exchange/Exchange.js#L162
