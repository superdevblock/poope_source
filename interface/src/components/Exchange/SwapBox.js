...
import { ARBITRUM, AVALANCHE, GOERLI_TESTNET, CRONOS, getChainName, getConstant, IS_NETWORK_DISABLED, isSupportedChain } from "config/chains";
                ...
                <div className="muted">
                  {fromUsdMin && (
                    <div className="Exchange-swap-usd">
                      <Trans>Pay: {formatAmount(fromUsdMin, USD_DECIMALS, 4, true)} USD</Trans>
                    </div>
                  )}
                  {!fromUsdMin && t`Pay`}
                </div>
            ...
            <div className="Exchange-swap-section">
              <div className="Exchange-swap-section-top">
                <div className="muted">
                  {toUsdMax && (
                    <div className="Exchange-swap-usd">
                      {getToLabel()}: {formatAmount(toUsdMax, USD_DECIMALS, 4, true)} USD
                    </div>
                  )}
                  {!toUsdMax && getToLabel()}
                </div>
              ...
              <div>
                ...
                {fees && (
                  <div>
                    ...
                    {fromToken.symbol}: ${formatAmount(feesUsd, USD_DECIMALS, 4, true)})
                  </div>
                )}
              </div>
            </ExchangeInfoRow>
          ...
          <div className="Exchange-leverage-box">
            ...
            <ExchangeInfoRow label={t`Fees`}>
              <div>
                ...
                {feesUsd && (
                  <Tooltip
                    handle={`$${formatAmount(feesUsd, USD_DECIMALS, 4, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <div>
      ...
      {isSwap && (
        <div className="Exchange-swap-market-box App-box App-box-border">
          ...
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              ${fromTokenInfo && formatAmount(fromTokenInfo.minPrice, USD_DECIMALS, 4, true)}
            </div>
          </div>
          <div className="Exchange-info-row">
            <div className="Exchange-info-label">
            ...
            <div className="align-right">
              ${toTokenInfo && formatAmount(toTokenInfo.maxPrice, USD_DECIMALS, 4, true)}
            </div>
          </div>
          <div className="Exchange-info-row">
            <div className="Exchange-info-label">
            ...
            <div className="align-right al-swap">
              <Tooltip
                handle={`$${formatAmount(maxSwapAmountUsd, USD_DECIMALS, 4, true)}`}
                position="right-bottom"
                renderContent={() => {
                  return (
                    <div>
        ...
        <div className="Exchange-swap-market-box App-box App-box-border">
          ...
          {isShort && toTokenInfo.hasMaxAvailableShort && (
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                <Tooltip
                  handle={`$${formatAmount(toTokenInfo.maxAvailableShort, USD_DECIMALS, 4, true)}`}
                  position="right-bottom"
                  renderContent={() => {
                    return (
                      <>
