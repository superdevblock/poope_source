...
function _storeReferralStats(
  ...
  entity.volumeCumulative = totalEntity? totalEntity.volume : BigInt.zero()
  entity.discountUsdCumulative = totalEntity? totalEntity.discountUsd : BigInt.zero()
...
function _storeGlobalStats(
  ...
  entity.volumeCumulative = totalEntity? totalEntity.volume : BigInt.zero()
  entity.totalRebateUsdCumulative = totalEntity? totalEntity.totalRebateUsd : BigInt.zero()
  entity.discountUsdCumulative = totalEntity? totalEntity.discountUsd : BigInt.zero()
  entity.tradesCumulative = totalEntity? totalEntity.trades : BigInt.zero()
  entity.referrersCountCumulative = totalEntity? totalEntity.referrersCount : BigInt.zero()
  entity.referralCodesCountCumulative = totalEntity? totalEntity.referralCodesCount : BigInt.zero()
...
function _storeReferrerStats(
  ...
  if (period == "total") {
    ...
    entity.volumeCumulative = totalEntity? totalEntity.volumeCumulative : BigInt.zero()
    entity.tradesCumulative = totalEntity? totalEntity.tradesCumulative : BigInt.zero()
    entity.totalRebateUsdCumulative = totalEntity? totalEntity.totalRebateUsdCumulative : BigInt.zero()
    entity.discountUsdCumulative = totalEntity? totalEntity.discountUsdCumulative : BigInt.zero()
    entity.tradedReferralsCountCumulative = totalEntity? totalEntity.tradedReferralsCount : BigInt.zero()
...
function _handleChangePositionReferral(
  ...
  entity.totalRebate = tierEntity? tierEntity.totalRebate : BigInt.zero()
  entity.discountShare = referrerEntity.discountShare > ZERO
    ? referrerEntity.discountShare : (tierEntity? tierEntity.discountShare : BigInt.zero())
