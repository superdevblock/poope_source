...
export function handleExecuteIncreasePosition(event: positionRouter.ExecuteIncreasePosition): void {
  let id = _getIdFromEvent(event)
  let entity = new ExecuteIncreasePosition(id)
...
export function handleExecuteDecreasePosition(event: positionRouter.ExecuteDecreasePosition): void {
  let id = _getIdFromEvent(event)
  let entity = new ExecuteDecreasePosition(id)
